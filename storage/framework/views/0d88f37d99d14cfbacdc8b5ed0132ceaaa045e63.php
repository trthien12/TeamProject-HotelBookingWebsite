...
<div class="container">
    <div class="phanthanmot">
        ...
        <a href="<?php echo e(url('/')); ?>" class="btn-complete">Quay lại trang chủ</a>
    </div>
</div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\BTN-PTUDMNM-tcdt\resources\views/thanhtoan/xong.blade.php ENDPATH**/ ?>