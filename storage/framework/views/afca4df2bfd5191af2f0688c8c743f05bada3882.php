...
<style>
    ...
    <div class="payment-container">
        ...
        <div class="qr-section">
            <img src="<?php echo e(asset('images/QR.png')); ?>" alt="QR Code" class="qr-code" />
            <p>Quét mã QR</p>
        </div>
        ...
        <div class="payment-info">
            <p><strong>Khách hàng:</strong> <?php echo e(session('customer_info.full_name')); ?></p>
            <p><strong>Số tiền thanh toán:</strong> <?php echo e(number_format(session('customer_info.total_amount'), 0, ',', '.')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\BTN-PTUDMNM-tcdt\resources\views/thanhtoan/payment.blade.php ENDPATH**/ ?>