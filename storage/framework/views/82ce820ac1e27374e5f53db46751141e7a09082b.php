...
<section class="book">
    <div class="container flex_space">
        ...
        <div class="form">
                <form action="<?php echo e(route('home.search')); ?>" class="grid" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Admin\Downloads\Baicua_\BTN-PTUDMNM-tcdt1\resources\views/homepage/sections/search.blade.php ENDPATH**/ ?>