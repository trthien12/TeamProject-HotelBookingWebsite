            ...
            <div class="booking-form">
                <h2 class="text-center">Đặt Phòng Khách Sạn</h2>
                    ...
                    <div class="infor-container-button d-flex justify-content-between">
                        <a href="<?php echo e(url('/')); ?>" class="back-btn btn btn-secondary"><span>&#171;</span> Quay lại</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\BTN-PTUDMNM-tcdt\resources\views/booking_form.blade.php ENDPATH**/ ?>