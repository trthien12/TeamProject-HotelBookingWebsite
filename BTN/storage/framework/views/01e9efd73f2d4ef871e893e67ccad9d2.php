        ...
        <div class="row">
            ...
            <div class="col-md-3 sidebar">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('rooms.index') ? 'active' : ''); ?>" href="<?php echo e(route('rooms.index')); ?>">
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/PTUDMNM/BTN/resources/views/layouts/app.blade.php ENDPATH**/ ?>